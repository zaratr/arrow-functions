...
//needs to have parenthesis or js will interprete it as a block
let objectLit = () =>(
    {key1: 'value1',
    key2: 'value2',
    key3: 'value3'});
...
//NOTICE: arrow functions are used with function constructors nor prototypes
...
// STEP 11
// How do arrow functions affect constructor functions? dont work for proto's because new keyword is used and 
// arrow func's cant use the new keyword
...
//    this references joe object with all its contents in the constructor function.
// 2. What is "this" when joe.scopeArrow() is invoked?
//  scope arrow refers to global object window that server use to request data (Apart of javascript)
// 3. Explain why "this" is different when an arrow function is used.
//arrow functions donot have thewir own argument object 
